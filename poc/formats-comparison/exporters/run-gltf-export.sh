#!/bin/bash
# Wrapper script to run glTF exporter with proper venv activation
# Usage: ./run-gltf-export.sh
...
echo -e "${GREEN}🚀 Running glTF+Draco Exporter${NC}"
echo "=================================="
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "Next steps:"
    echo "  1. Check output: ls -lh ../dataset/gltf-draco/"
    echo "  2. Run ThatOpen export: ./run-fragments-export.sh"
